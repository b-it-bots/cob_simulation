...
class gazebo_services():
	...
	def __init__(self):
		# base
		self.base_client = actionlib.SimpleActionServer('/move_base', MoveBaseAction, execute_cb=self.move_base_cb)
		...
		#torso
		self.torso_client = actionlib.SimpleActionServer('/torso_controller/follow_joint_trajectory', FollowJointTrajectoryAction, execute_cb=self.torso_traj_cb)
		...
		#tray
		self.tray_client = actionlib.SimpleActionServer('/tray_controller/follow_joint_trajectory', FollowJointTrajectoryAction, execute_cb=self.tray_traj_cb)
		...
		#arm
		self.arm_client = actionlib.SimpleActionServer('/arm_controller/follow_joint_trajectory', FollowJointTrajectoryAction, execute_cb=self.arm_traj_cb)
		...
		#arm left
		self.arm_left_client = actionlib.SimpleActionServer('/arm_left_controller/follow_joint_trajectory', FollowJointTrajectoryAction, execute_cb=self.arm_left_traj_cb)
		...
		#arm right
		self.arm_right_client = actionlib.SimpleActionServer('/arm_right_controller/follow_joint_trajectory', FollowJointTrajectoryAction, execute_cb=self.arm_right_traj_cb)
		...
		#sdh
		self.sdh_client = actionlib.SimpleActionServer('/sdh_controller/follow_joint_trajectory', FollowJointTrajectoryAction, execute_cb=self.sdh_traj_cb)
		...
		#sdh left
		self.sdh_left_client = actionlib.SimpleActionServer('/sdh_left_controller/follow_joint_trajectory', FollowJointTrajectoryAction, execute_cb=self.sdh_left_traj_cb)
		...
		#sdh right
		self.sdh_right_client = actionlib.SimpleActionServer('/sdh_right_controller/follow_joint_trajectory', FollowJointTrajectoryAction, execute_cb=self.sdh_right_traj_cb)
		...
		#head
		self.head_client = actionlib.SimpleActionServer('/head_controller/follow_joint_trajectory', FollowJointTrajectoryAction, execute_cb=self.head_traj_cb)
	...
	def torso_traj_cb(self, req):
		self.torso_client.set_succeeded()

	def tray_traj_cb(self, req):
		self.tray_client.set_succeeded()

	def head_traj_cb(self, req):
		self.head_client.set_succeeded()

	def arm_traj_cb(self, req):
		self.arm_client.set_succeeded()
	
	def arm_right_traj_cb(self, req):
		self.arm_right_client.set_succeeded()
	
	def arm_left_traj_cb(self, req):
		self.arm_left_client.set_succeeded()

	def sdh_traj_cb(self, req):
		self.sdh_client.set_succeeded()

	def sdh_left_traj_cb(self, req):
		self.sdh_left_client.set_succeeded()

	def sdh_right_traj_cb(self, req):
		self.sdh_right_client.set_succeeded()
